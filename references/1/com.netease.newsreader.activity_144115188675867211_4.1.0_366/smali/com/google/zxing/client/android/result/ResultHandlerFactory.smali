...
.method public static makeResultHandler(Lcom/google/zxing/client/android/CaptureActivity;Lcom/google/zxing/Result;)Lcom/google/zxing/client/android/result/ResultHandler;
    ...
    :pswitch_0
    new-instance v0, Lcom/google/zxing/client/android/result/TextResultHandler;

    invoke-direct {v0, p0, v1, p1}, Lcom/google/zxing/client/android/result/TextResultHandler;-><init>(Landroid/app/Activity;Lcom/google/zxing/client/result/ParsedResult;Lcom/google/zxing/Result;)V

    :goto_0
    return-object v0

    :pswitch_1
    new-instance v0, Lcom/google/zxing/client/android/result/AddressBookResultHandler;

    invoke-direct {v0, p0, v1}, Lcom/google/zxing/client/android/result/AddressBookResultHandler;-><init>(Landroid/app/Activity;Lcom/google/zxing/client/result/ParsedResult;)V

    goto :goto_0

    :pswitch_2
    new-instance v0, Lcom/google/zxing/client/android/result/EmailAddressResultHandler;

    invoke-direct {v0, p0, v1}, Lcom/google/zxing/client/android/result/EmailAddressResultHandler;-><init>(Landroid/app/Activity;Lcom/google/zxing/client/result/ParsedResult;)V

    goto :goto_0

    :pswitch_3
    new-instance v0, Lcom/google/zxing/client/android/result/ProductResultHandler;

    invoke-direct {v0, p0, v1, p1}, Lcom/google/zxing/client/android/result/ProductResultHandler;-><init>(Landroid/app/Activity;Lcom/google/zxing/client/result/ParsedResult;Lcom/google/zxing/Result;)V

    goto :goto_0

    :pswitch_4
    new-instance v0, Lcom/google/zxing/client/android/result/URIResultHandler;

    invoke-direct {v0, p0, v1}, Lcom/google/zxing/client/android/result/URIResultHandler;-><init>(Landroid/app/Activity;Lcom/google/zxing/client/result/ParsedResult;)V

    goto :goto_0

    :pswitch_5
    new-instance v0, Lcom/google/zxing/client/android/result/WifiResultHandler;

    invoke-direct {v0, p0, v1}, Lcom/google/zxing/client/android/result/WifiResultHandler;-><init>(Lcom/google/zxing/client/android/CaptureActivity;Lcom/google/zxing/client/result/ParsedResult;)V

    goto :goto_0

    :pswitch_6
    new-instance v0, Lcom/google/zxing/client/android/result/GeoResultHandler;

    invoke-direct {v0, p0, v1}, Lcom/google/zxing/client/android/result/GeoResultHandler;-><init>(Landroid/app/Activity;Lcom/google/zxing/client/result/ParsedResult;)V

    goto :goto_0

    :pswitch_7
    new-instance v0, Lcom/google/zxing/client/android/result/TelResultHandler;

    invoke-direct {v0, p0, v1}, Lcom/google/zxing/client/android/result/TelResultHandler;-><init>(Landroid/app/Activity;Lcom/google/zxing/client/result/ParsedResult;)V

    goto :goto_0

    :pswitch_8
    new-instance v0, Lcom/google/zxing/client/android/result/SMSResultHandler;

    invoke-direct {v0, p0, v1}, Lcom/google/zxing/client/android/result/SMSResultHandler;-><init>(Landroid/app/Activity;Lcom/google/zxing/client/result/ParsedResult;)V

    goto :goto_0

    :pswitch_9
    new-instance v0, Lcom/google/zxing/client/android/result/CalendarResultHandler;

    invoke-direct {v0, p0, v1}, Lcom/google/zxing/client/android/result/CalendarResultHandler;-><init>(Landroid/app/Activity;Lcom/google/zxing/client/result/ParsedResult;)V

    goto :goto_0

    :pswitch_a
    new-instance v0, Lcom/google/zxing/client/android/result/ISBNResultHandler;

    invoke-direct {v0, p0, v1, p1}, Lcom/google/zxing/client/android/result/ISBNResultHandler;-><init>(Landroid/app/Activity;Lcom/google/zxing/client/result/ParsedResult;Lcom/google/zxing/Result;)V
