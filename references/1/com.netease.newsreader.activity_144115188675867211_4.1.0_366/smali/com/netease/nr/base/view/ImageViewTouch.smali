...
.field protected final c:Lcom/netease/nr/base/view/ac;
...
.field private i:Lcom/netease/nr/base/view/ad;
...
.field private m:Lcom/netease/nr/base/view/ab;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, v2}, Lcom/netease/nr/base/view/ac;-><init>(Landroid/graphics/Bitmap;)V

    iput-object v0, p0, Lcom/netease/nr/base/view/ImageViewTouch;->c:Lcom/netease/nr/base/view/ac;
    ...
    invoke-direct {p0}, Lcom/netease/nr/base/view/ImageViewTouch;->o()V
...
.method private a(Landroid/graphics/Bitmap;I)V
    ...
    :cond_2
    iget-object v0, p0, Lcom/netease/nr/base/view/ImageViewTouch;->c:Lcom/netease/nr/base/view/ac;

    invoke-virtual {v0}, Lcom/netease/nr/base/view/ac;->b()Landroid/graphics/Bitmap;

    move-result-object v0

    iget-object v1, p0, Lcom/netease/nr/base/view/ImageViewTouch;->c:Lcom/netease/nr/base/view/ac;

    invoke-virtual {v1, p1}, Lcom/netease/nr/base/view/ac;->a(Landroid/graphics/Bitmap;)V

    iget-object v1, p0, Lcom/netease/nr/base/view/ImageViewTouch;->c:Lcom/netease/nr/base/view/ac;

    invoke-virtual {v1, p2}, Lcom/netease/nr/base/view/ac;->a(I)V

    if-eqz v0, :cond_0

    if-eq v0, p1, :cond_0

    iget-object v1, p0, Lcom/netease/nr/base/view/ImageViewTouch;->m:Lcom/netease/nr/base/view/ab;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/netease/nr/base/view/ImageViewTouch;->m:Lcom/netease/nr/base/view/ab;

    invoke-interface {v1, v0}, Lcom/netease/nr/base/view/ab;->a(Landroid/graphics/Bitmap;)V

    goto :goto_0
.end method

.method public static a(IF)Z
    .locals 3
...
.method private o()V
    ...
    invoke-direct {v0, v1}, Lcom/netease/nr/base/view/ad;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/netease/nr/base/view/ImageViewTouch;->i:Lcom/netease/nr/base/view/ad;
...
.method protected a(ZZ)I
    ...
    invoke-virtual {v1}, Lcom/netease/nr/base/view/ac;->b()Landroid/graphics/Bitmap;
    ...
    :cond_1
    :goto_2
    invoke-virtual {p0, v0, v2}, Lcom/netease/nr/base/view/ImageViewTouch;->b(FF)V
...
.method protected a(FFFF)V
    ...
    invoke-direct/range {v0 .. v8}, Lcom/netease/nr/base/view/aa;-><init>(Lcom/netease/nr/base/view/ImageViewTouch;FJFFFF)V
...
.method public a(Landroid/graphics/Bitmap;Z)V
    ...
    invoke-direct {v0, p1}, Lcom/netease/nr/base/view/ac;-><init>(Landroid/graphics/Bitmap;)V

    invoke-virtual {p0, v0, p2}, Lcom/netease/nr/base/view/ImageViewTouch;->a(Lcom/netease/nr/base/view/ac;Z)V

    return-void
.end method

.method protected a(Lcom/netease/nr/base/view/ac;Landroid/graphics/Matrix;)V
    .locals 8
    ...
    invoke-virtual {p1}, Lcom/netease/nr/base/view/ac;->f()I

    move-result v0

    int-to-float v4, v0

    invoke-virtual {p1}, Lcom/netease/nr/base/view/ac;->e()I
    ...
    :goto_0
    invoke-virtual {p1}, Lcom/netease/nr/base/view/ac;->c()Landroid/graphics/Matrix;
...
.method public a(Lcom/netease/nr/base/view/ac;Z)V
    .locals 5
    ...
    new-instance v0, Lcom/netease/nr/base/view/y;

    invoke-direct {v0, p0, p1, p2}, Lcom/netease/nr/base/view/y;-><init>(Lcom/netease/nr/base/view/ImageViewTouch;Lcom/netease/nr/base/view/ac;Z)V
    ...
    :cond_1
    iput-boolean v4, p0, Lcom/netease/nr/base/view/ImageViewTouch;->k:Z

    invoke-virtual {p1}, Lcom/netease/nr/base/view/ac;->b()Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/netease/nr/base/view/ImageViewTouch;->a(Lcom/netease/nr/base/view/ac;Landroid/graphics/Matrix;)V

    invoke-virtual {p1}, Lcom/netease/nr/base/view/ac;->b()Landroid/graphics/Bitmap;

    move-result-object v0

    invoke-virtual {p1}, Lcom/netease/nr/base/view/ac;->a()I
    ...
    :goto_1
    iput-boolean v3, p0, Lcom/netease/nr/base/view/ImageViewTouch;->k:Z
    ...
    invoke-virtual {p0}, Lcom/netease/nr/base/view/ImageViewTouch;->h()Z
    ...
    invoke-virtual {p0, v4, v2}, Lcom/netease/nr/base/view/ImageViewTouch;->setLayerType(ILandroid/graphics/Paint;)V
    ...
    invoke-virtual {p0, v2}, Lcom/netease/nr/base/view/ImageViewTouch;->setImageBitmap(Landroid/graphics/Bitmap;)V

    goto :goto_1

    :cond_4
    invoke-virtual {p0, v3, v2}, Lcom/netease/nr/base/view/ImageViewTouch;->setLayerType(ILandroid/graphics/Paint;)V
...
.method protected a(ZZF)V
    ...
    iget-object v3, p0, Lcom/netease/nr/base/view/ImageViewTouch;->c:Lcom/netease/nr/base/view/ac;

    invoke-virtual {v3}, Lcom/netease/nr/base/view/ac;->b()Landroid/graphics/Bitmap;
    ...
    iget-object v4, p0, Lcom/netease/nr/base/view/ImageViewTouch;->c:Lcom/netease/nr/base/view/ac;

    invoke-virtual {v4}, Lcom/netease/nr/base/view/ac;->b()Landroid/graphics/Bitmap;
    ...
    invoke-direct/range {v0 .. v8}, Lcom/netease/nr/base/view/z;-><init>(Lcom/netease/nr/base/view/ImageViewTouch;FJLandroid/graphics/PointF;FLandroid/graphics/PointF;F)V
...
.method protected a(FF)Z
    ...
    iget-object v2, p0, Lcom/netease/nr/base/view/ImageViewTouch;->c:Lcom/netease/nr/base/view/ac;

    invoke-virtual {v2}, Lcom/netease/nr/base/view/ac;->b()Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0}, Lcom/netease/nr/base/view/ImageViewTouch;->n()I

    move-result v2

    invoke-static {v2, p1}, Lcom/netease/nr/base/view/ImageViewTouch;->a(IF)Z
...
.method protected c(FF)I
    ...
    invoke-virtual {p0, p1, p2}, Lcom/netease/nr/base/view/ImageViewTouch;->b(FF)V
...
.method public computeScroll()V
    ...
    iget-object v0, p0, Lcom/netease/nr/base/view/ImageViewTouch;->i:Lcom/netease/nr/base/view/ad;

    invoke-virtual {v0, p0}, Lcom/netease/nr/base/view/ad;->a(Lcom/netease/nr/base/view/ImageViewTouch;)V
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/netease/nr/base/view/ImageViewTouch;->a(Lcom/netease/nr/base/view/ac;Landroid/graphics/Matrix;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p0, p1}, Lcom/netease/nr/base/view/ad;->a(Lcom/netease/nr/base/view/ImageViewTouch;Landroid/view/MotionEvent;)Z
