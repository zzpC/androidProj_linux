...
# instance fields
.field private a:Lcom/netease/nr/base/view/bm;

.field private b:Lcom/netease/nr/base/b/c;
...
.method static synthetic a(Lcom/netease/nr/base/view/PullListView;)Lcom/netease/nr/base/view/PullRefreshListView;
    .locals 1
...
.method private a(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/netease/nr/base/view/bm;-><init>(Lcom/netease/nr/base/view/PullListView;Landroid/content/Context;)V

    iput-object v0, p0, Lcom/netease/nr/base/view/PullListView;->a:Lcom/netease/nr/base/view/bm;
...
.method public a(Landroid/view/View;)V
    ...
    iget-object v0, p0, Lcom/netease/nr/base/view/PullListView;->a:Lcom/netease/nr/base/view/bm;

    invoke-virtual {v0}, Lcom/netease/nr/base/view/bm;->removeAllViews()V

    if-eqz p1, :cond_0

    iget-object v0, p0, Lcom/netease/nr/base/view/PullListView;->a:Lcom/netease/nr/base/view/bm;

    invoke-virtual {v0, p1}, Lcom/netease/nr/base/view/bm;->addView(Landroid/view/View;)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0}, Lcom/netease/nr/base/view/PullListView;->getBackground()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-virtual {p0}, Lcom/netease/nr/base/view/PullListView;->getFirstVisiblePosition()I
    ...
    iget-object v3, p0, Lcom/netease/nr/base/view/PullListView;->a:Lcom/netease/nr/base/view/bm;

    invoke-virtual {v3}, Lcom/netease/nr/base/view/bm;->getBottom()I

    move-result v3

    invoke-virtual {p0}, Lcom/netease/nr/base/view/PullListView;->getWidth()I
...
.method protected onAttachedToWindow()V
    ...
    iget-object v0, p0, Lcom/netease/nr/base/view/PullListView;->b:Lcom/netease/nr/base/b/c;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/netease/nr/base/view/PullListView;->b:Lcom/netease/nr/base/b/c;

    iget-object v1, p0, Lcom/netease/nr/base/view/PullListView;->a:Lcom/netease/nr/base/view/bm;
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    iput-object v2, p0, Lcom/netease/nr/base/view/PullListView;->b:Lcom/netease/nr/base/b/c;
    ...
    invoke-direct {v0, p1, v1, v2}, Lcom/netease/nr/base/b/c;-><init>(Landroid/widget/ListAdapter;Landroid/view/View;Landroid/view/View;)V

    iput-object v0, p0, Lcom/netease/nr/base/view/PullListView;->b:Lcom/netease/nr/base/b/c;
...
.method public setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/netease/nr/base/view/bj;-><init>(Lcom/netease/nr/base/view/PullListView;Landroid/widget/AdapterView$OnItemClickListener;)V
...
.method public setOnItemLongClickListener(Landroid/widget/AdapterView$OnItemLongClickListener;)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/netease/nr/base/view/bk;-><init>(Lcom/netease/nr/base/view/PullListView;Landroid/widget/AdapterView$OnItemLongClickListener;)V
...
.method public setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V
    ...
    new-instance v0, Lcom/netease/nr/base/view/bl;

    invoke-direct {v0, p0, p1}, Lcom/netease/nr/base/view/bl;-><init>(Lcom/netease/nr/base/view/PullListView;Landroid/widget/AdapterView$OnItemSelectedListener;)V
