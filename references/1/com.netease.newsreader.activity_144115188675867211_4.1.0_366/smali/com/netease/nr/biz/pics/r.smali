.class public Lcom/netease/nr/biz/pics/r;
...
.method public static a(Landroid/content/Context;Ljava/lang/String;)Landroid/util/Pair;
    ...
    :goto_0
    invoke-static {v0, p1}, Lcom/netease/util/d/d;->d(Ljava/util/Map;Ljava/lang/String;)Ljava/util/List;
    ...
    const-string v4, "photo_clientcover"
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Z)Ljava/util/Map;
    ...
    const-string v0, "http://c.m.163.com/photo/api/set/%s/%s.json"
    ...
    :cond_1
    invoke-static {p0, v0, v1}, Lcom/netease/util/e/a;->d(Landroid/content/Context;Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;
    ...
    const-string v0, "http://c.m.163.com/photo/api/related/%s/%s.json"
    ...
    :cond_2
    invoke-static {v1, v0, p1}, Lcom/netease/nr/biz/pics/r;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/Map;
...
.method private static a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-static {v0, v3}, Lcom/netease/util/d/d;->a(Lorg/json/JSONObject;Z)Ljava/util/Map;
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;ZLjava/lang/String;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v0 .. v6}, Lcom/netease/nr/biz/pics/s;-><init>(ZLcom/netease/nr/base/activity/BaseApplication;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;)V

    invoke-virtual {v2, v0}, Lcom/netease/nr/base/activity/BaseApplication;->a(Ljava/lang/Runnable;)V
