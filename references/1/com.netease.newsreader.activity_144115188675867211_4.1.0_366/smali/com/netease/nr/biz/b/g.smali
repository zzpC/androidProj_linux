.class public Lcom/netease/nr/biz/b/g;
...
.method private static a(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-direct {v2, p0}, Lt4j/org/json/JSONArray;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v6}, Lt4j/org/json/JSONObject;->getString(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v5, "fontTitle"

    const-string v6, "fontTitle"
    ...
    const-string v5, "regularName"

    const-string v6, "regularName"
    ...
    const-string v5, "boldName"

    const-string v6, "boldName"
...
.method public static a(Landroid/content/Context;II)Ljava/util/Map;
    ...
    const-string v0, "http://m.163.com/special/newsclient/fonts_android.html"
    ...
    :cond_0
    invoke-static {v0}, Lcom/netease/nr/biz/b/g;->a(Ljava/lang/String;)Ljava/util/List;
...
.method public static a(Landroid/content/Context;Ljava/util/List;Z)V
    ...
    const-string v6, "font_img"

    const-string v7, "previewUrl"

    invoke-static {v1, v7}, Lcom/netease/util/d/d;->b(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v6, "font_regular_name"

    const-string v7, "regularName"
    ...
    const-string v6, "font_bold_name"

    const-string v7, "boldName"
    ...
    const-string v6, "font_prizeid"

    const-string v7, "prizeId"
...
.method public static a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object v9, Lcom/netease/nr/base/c/a;->i:Ljava/lang/String;
    ...
    invoke-virtual {v5, v4, v7, v0}, Ljava/io/OutputStream;->write([BII)V
