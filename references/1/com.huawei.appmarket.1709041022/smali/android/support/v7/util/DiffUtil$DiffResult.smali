...
.method private addRootSnake()V
    ...
    iget v1, v0, Landroid/support/v7/util/DiffUtil$c;->a:I
    ...
    iput v2, v0, Landroid/support/v7/util/DiffUtil$c;->a:I

    iput v2, v0, Landroid/support/v7/util/DiffUtil$c;->b:I

    iput-boolean v2, v0, Landroid/support/v7/util/DiffUtil$c;->d:Z

    iput v2, v0, Landroid/support/v7/util/DiffUtil$c;->c:I

    iput-boolean v2, v0, Landroid/support/v7/util/DiffUtil$c;->e:Z
...
.method private dispatchAdditions(Ljava/util/List;Landroid/support/v7/util/ListUpdateCallback;III)V
    ...
    check-cast v0, Landroid/support/v7/util/DiffUtil$a;

    iget v3, v0, Landroid/support/v7/util/DiffUtil$a;->b:I

    add-int/lit8 v3, v3, 0x1

    iput v3, v0, Landroid/support/v7/util/DiffUtil$a;->b:I
    ...
    invoke-static {p1, v2, v4}, Landroid/support/v7/util/DiffUtil$DiffResult;->removePostponedUpdate(Ljava/util/List;IZ)Landroid/support/v7/util/DiffUtil$a;

    move-result-object v3

    iget v3, v3, Landroid/support/v7/util/DiffUtil$a;->b:I
    ...
    :sswitch_2
    new-instance v0, Landroid/support/v7/util/DiffUtil$a;

    add-int v2, p5, v1

    const/4 v3, 0x0

    invoke-direct {v0, v2, p3, v3}, Landroid/support/v7/util/DiffUtil$a;-><init>(IIZ)V
...
.method private dispatchRemovals(Ljava/util/List;Landroid/support/v7/util/ListUpdateCallback;III)V
    ...
    invoke-static {p1, v2, v3}, Landroid/support/v7/util/DiffUtil$DiffResult;->removePostponedUpdate(Ljava/util/List;IZ)Landroid/support/v7/util/DiffUtil$a;

    move-result-object v3

    add-int v4, p3, v1

    iget v5, v3, Landroid/support/v7/util/DiffUtil$a;->b:I
    ...
    iget v0, v3, Landroid/support/v7/util/DiffUtil$a;->b:I
    ...
    invoke-direct {v0, v2, v3, v6}, Landroid/support/v7/util/DiffUtil$a;-><init>(IIZ)V
...
.method private findMatchingItem(IIIZ)Z
    ...
    iget v6, v0, Landroid/support/v7/util/DiffUtil$c;->a:I

    iget v7, v0, Landroid/support/v7/util/DiffUtil$c;->c:I

    add-int/2addr v6, v7

    iget v7, v0, Landroid/support/v7/util/DiffUtil$c;->b:I

    iget v8, v0, Landroid/support/v7/util/DiffUtil$c;->c:I
    ...
    :cond_6
    iget v5, v0, Landroid/support/v7/util/DiffUtil$c;->a:I

    iget p2, v0, Landroid/support/v7/util/DiffUtil$c;->b:I
...
.method private findMatchingItems()V
    ...
    iget v4, v0, Landroid/support/v7/util/DiffUtil$c;->a:I

    iget v5, v0, Landroid/support/v7/util/DiffUtil$c;->c:I

    add-int/2addr v4, v5

    iget v5, v0, Landroid/support/v7/util/DiffUtil$c;->b:I

    iget v6, v0, Landroid/support/v7/util/DiffUtil$c;->c:I
    ...
    :goto_3
    iget v2, v0, Landroid/support/v7/util/DiffUtil$c;->c:I
    ...
    iget v2, v0, Landroid/support/v7/util/DiffUtil$c;->b:I
    ...
    iget v1, v0, Landroid/support/v7/util/DiffUtil$c;->b:I
...
.method private static removePostponedUpdate(Ljava/util/List;IZ)Landroid/support/v7/util/DiffUtil$a;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget v2, v0, Landroid/support/v7/util/DiffUtil$a;->a:I

    if-ne v2, p1, :cond_1

    iget-boolean v2, v0, Landroid/support/v7/util/DiffUtil$a;->c:Z
    ...
    check-cast v1, Landroid/support/v7/util/DiffUtil$a;

    iget v4, v1, Landroid/support/v7/util/DiffUtil$a;->b:I
    ...
    iput v3, v1, Landroid/support/v7/util/DiffUtil$a;->b:I
...
.method public dispatchUpdatesTo(Landroid/support/v7/util/ListUpdateCallback;)V
    ...
    check-cast v6, Landroid/support/v7/util/DiffUtil$c;

    iget v9, v6, Landroid/support/v7/util/DiffUtil$c;->c:I

    iget v0, v6, Landroid/support/v7/util/DiffUtil$c;->a:I

    add-int v3, v0, v9

    iget v0, v6, Landroid/support/v7/util/DiffUtil$c;->b:I
    ...
    iget v4, v6, Landroid/support/v7/util/DiffUtil$c;->a:I
    ...
    iget v3, v6, Landroid/support/v7/util/DiffUtil$c;->a:I
    ...
    iget v8, v6, Landroid/support/v7/util/DiffUtil$c;->a:I

    add-int/2addr v8, v0

    iget v9, v6, Landroid/support/v7/util/DiffUtil$c;->b:I
    ...
    iget v3, v6, Landroid/support/v7/util/DiffUtil$c;->b:I
