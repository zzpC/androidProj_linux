...
.method public constructor <init>(Landroid/support/v7/widget/RecyclerView;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$d;->e:Landroid/view/animation/Interpolator;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$d;->d:Landroid/support/v4/widget/ScrollerCompat;
...
.method private b(IIII)I
    ...
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$d;->a:Landroid/support/v7/widget/RecyclerView;
    ...
    invoke-direct {p0, v5}, Landroid/support/v7/widget/RecyclerView$d;->a(F)F
...
.method public a(II)V
    ...
    iput v1, p0, Landroid/support/v7/widget/RecyclerView$d;->c:I

    iput v1, p0, Landroid/support/v7/widget/RecyclerView$d;->b:I

    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$d;->d:Landroid/support/v4/widget/ScrollerCompat;
...
.method public a(IIII)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Landroid/support/v7/widget/RecyclerView$d;->a(III)V
...
.method public a(IIILandroid/view/animation/Interpolator;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$d;->e:Landroid/view/animation/Interpolator;

    if-eq v0, p4, :cond_0

    iput-object p4, p0, Landroid/support/v7/widget/RecyclerView$d;->e:Landroid/view/animation/Interpolator;
...
.method public run()V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/RecyclerView$d;->b()V

    :goto_0
    return-void

    :cond_0
    invoke-direct {p0}, Landroid/support/v7/widget/RecyclerView$d;->c()V

    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$d;->a:Landroid/support/v7/widget/RecyclerView;

    invoke-static {v0}, Landroid/support/v7/widget/RecyclerView;->access$400(Landroid/support/v7/widget/RecyclerView;)V

    iget-object v7, p0, Landroid/support/v7/widget/RecyclerView$d;->d:Landroid/support/v4/widget/ScrollerCompat;
    ...
    iget v0, p0, Landroid/support/v7/widget/RecyclerView$d;->b:I

    sub-int v11, v9, v0

    iget v0, p0, Landroid/support/v7/widget/RecyclerView$d;->c:I
    ...
    iput v9, p0, Landroid/support/v7/widget/RecyclerView$d;->b:I

    iput v10, p0, Landroid/support/v7/widget/RecyclerView$d;->c:I

    const/4 v2, 0x0

    const/4 v0, 0x0

    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView$d;->a:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView$d;->a:Landroid/support/v7/widget/RecyclerView;

    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->mLayout:Landroid/support/v7/widget/RecyclerView$LayoutManager;

    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView$d;->a:Landroid/support/v7/widget/RecyclerView;
    ...
    :cond_13
    invoke-direct {p0}, Landroid/support/v7/widget/RecyclerView$d;->d()V
