...
.method static synthetic access$1500(Landroid/support/v7/widget/helper/ItemTouchHelper;Landroid/support/v7/widget/helper/ItemTouchHelper$b;I)V
    .locals 0

    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/helper/ItemTouchHelper;->postDispatchSwipe(Landroid/support/v7/widget/helper/ItemTouchHelper$b;I)V
...
.method static synthetic access$600(Landroid/support/v7/widget/helper/ItemTouchHelper;Landroid/view/MotionEvent;)Landroid/support/v7/widget/helper/ItemTouchHelper$b;
    .locals 1

    invoke-direct {p0, p1}, Landroid/support/v7/widget/helper/ItemTouchHelper;->findAnimation(Landroid/view/MotionEvent;)Landroid/support/v7/widget/helper/ItemTouchHelper$b;
...
.method private endRecoverAnimation(Landroid/support/v7/widget/RecyclerView$ViewHolder;Z)I
    ...
    iget-object v2, v0, Landroid/support/v7/widget/helper/ItemTouchHelper$b;->h:Landroid/support/v7/widget/RecyclerView$ViewHolder;

    if-ne v2, p1, :cond_1

    iget-boolean v2, v0, Landroid/support/v7/widget/helper/ItemTouchHelper$b;->m:Z

    or-int/2addr v2, p2

    iput-boolean v2, v0, Landroid/support/v7/widget/helper/ItemTouchHelper$b;->m:Z

    invoke-static {v0}, Landroid/support/v7/widget/helper/ItemTouchHelper$b;->a(Landroid/support/v7/widget/helper/ItemTouchHelper$b;)Z

    move-result v2

    if-nez v2, :cond_0

    invoke-virtual {v0}, Landroid/support/v7/widget/helper/ItemTouchHelper$b;->b()V
    ...
    invoke-static {v0}, Landroid/support/v7/widget/helper/ItemTouchHelper$b;->b(Landroid/support/v7/widget/helper/ItemTouchHelper$b;)I
...
.method private findAnimation(Landroid/view/MotionEvent;)Landroid/support/v7/widget/helper/ItemTouchHelper$b;
    .locals 5
...
.method private findChildView(Landroid/view/MotionEvent;)Landroid/view/View;
    ...
    iget-object v1, v0, Landroid/support/v7/widget/helper/ItemTouchHelper$b;->h:Landroid/support/v7/widget/RecyclerView$ViewHolder;

    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView$ViewHolder;->itemView:Landroid/view/View;

    iget v5, v0, Landroid/support/v7/widget/helper/ItemTouchHelper$b;->k:F

    iget v0, v0, Landroid/support/v7/widget/helper/ItemTouchHelper$b;->l:F
...
.method private initGestureDetector()V
    ...
    new-instance v2, Landroid/support/v7/widget/helper/ItemTouchHelper$a;

    const/4 v3, 0x0

    invoke-direct {v2, p0, v3}, Landroid/support/v7/widget/helper/ItemTouchHelper$a;-><init>(Landroid/support/v7/widget/helper/ItemTouchHelper;Landroid/support/v7/widget/helper/ItemTouchHelper$1;)V
...
.method private postDispatchSwipe(Landroid/support/v7/widget/helper/ItemTouchHelper$b;I)V
    .locals 2
    ...
    invoke-direct {v1, p0, p1, p2}, Landroid/support/v7/widget/helper/ItemTouchHelper$4;-><init>(Landroid/support/v7/widget/helper/ItemTouchHelper;Landroid/support/v7/widget/helper/ItemTouchHelper$b;I)V
...
.method private select(Landroid/support/v7/widget/RecyclerView$ViewHolder;I)V
    ...
    invoke-virtual {v0, v2, v3}, Landroid/support/v7/widget/helper/ItemTouchHelper$b;->a(J)V

    iget-object v1, p0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mRecoverAnimations:Ljava/util/List;

    invoke-interface {v1, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v0}, Landroid/support/v7/widget/helper/ItemTouchHelper$b;->a()V
