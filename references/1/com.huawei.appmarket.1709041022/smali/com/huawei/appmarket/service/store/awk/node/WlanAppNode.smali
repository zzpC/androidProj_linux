.class public Lcom/huawei/appmarket/service/store/awk/node/WlanAppNode;
...
.method public createChildNode(Landroid/view/ViewGroup;Landroid/view/ViewGroup;)Z
    ...
    invoke-virtual {p0}, Lcom/huawei/appmarket/service/store/awk/node/WlanAppNode;->getCardNumberPreLine()I

    move-result v3

    iget-object v0, p0, Lcom/huawei/appmarket/service/store/awk/node/WlanAppNode;->context:Landroid/content/Context;
    ...
    iget-object v6, p0, Lcom/huawei/appmarket/service/store/awk/node/WlanAppNode;->context:Landroid/content/Context;

    invoke-direct {v5, v6}, Lcom/huawei/appmarket/framework/widget/SpaceEx;-><init>(Landroid/content/Context;)V

    new-instance v6, Landroid/widget/LinearLayout$LayoutParams;

    iget v7, p0, Lcom/huawei/appmarket/service/store/awk/node/WlanAppNode;->cardSpace:I
    ...
    :cond_0
    sget v5, Lcom/huawei/appmarket/a/a$h;->applistitem_wlanapp:I
    ...
    new-instance v6, Lcom/huawei/appmarket/service/store/awk/card/WlanAppCard;

    iget-object v7, p0, Lcom/huawei/appmarket/service/store/awk/node/WlanAppNode;->context:Landroid/content/Context;

    invoke-direct {v6, v7}, Lcom/huawei/appmarket/service/store/awk/card/WlanAppCard;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, v6}, Lcom/huawei/appmarket/service/store/awk/node/WlanAppNode;->addCard(Lcom/huawei/appmarket/sdk/service/cardkit/a/a;)V
