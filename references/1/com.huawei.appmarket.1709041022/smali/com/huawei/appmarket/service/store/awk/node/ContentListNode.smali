.class public Lcom/huawei/appmarket/service/store/awk/node/ContentListNode;
...
.method public createChildNode(Landroid/view/ViewGroup;Landroid/view/ViewGroup;)Z
    ...
    iget-object v5, p0, Lcom/huawei/appmarket/service/store/awk/node/ContentListNode;->context:Landroid/content/Context;

    invoke-static {v5, v1, v3, v4, v0}, Lcom/huawei/appmarket/support/c/m;->a(Landroid/content/Context;IIII)Landroid/widget/RelativeLayout$LayoutParams;

    move-result-object v3

    invoke-virtual {p0}, Lcom/huawei/appmarket/service/store/awk/node/ContentListNode;->getCardNumberPreLine()I

    move-result v4

    iget-object v1, p0, Lcom/huawei/appmarket/service/store/awk/node/ContentListNode;->context:Landroid/content/Context;
    ...
    sget v8, Lcom/huawei/appmarket/a/a$d;->margin_offset_for_pad:I

    invoke-virtual {v1, v8}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v1

    invoke-virtual {v7, v1, v0, v1, v0}, Landroid/widget/LinearLayout$LayoutParams;->setMargins(IIII)V
    ...
    iget-object v8, p0, Lcom/huawei/appmarket/service/store/awk/node/ContentListNode;->context:Landroid/content/Context;
    ...
    :cond_1
    sget v0, Lcom/huawei/appmarket/a/a$h;->content_item_normal:I
    ...
    iget-object v9, p0, Lcom/huawei/appmarket/service/store/awk/node/ContentListNode;->context:Landroid/content/Context;
    ...
    new-instance v8, Lcom/huawei/appmarket/service/store/awk/card/ContentNormalItemCard;

    iget-object v9, p0, Lcom/huawei/appmarket/service/store/awk/node/ContentListNode;->context:Landroid/content/Context;

    invoke-direct {v8, v9}, Lcom/huawei/appmarket/service/store/awk/card/ContentNormalItemCard;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, v8}, Lcom/huawei/appmarket/service/store/awk/node/ContentListNode;->addCard(Lcom/huawei/appmarket/sdk/service/cardkit/a/a;)V
