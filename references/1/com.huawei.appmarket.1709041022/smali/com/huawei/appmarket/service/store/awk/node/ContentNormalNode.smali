.class public Lcom/huawei/appmarket/service/store/awk/node/ContentNormalNode;
...
.method public createChildNode(Landroid/view/ViewGroup;Landroid/view/ViewGroup;)Z
    ...
    iget-object v1, v0, Lcom/huawei/appmarket/service/store/awk/node/ContentNormalNode;->context:Landroid/content/Context;
    ...
    new-instance v8, Lcom/huawei/appmarket/service/store/awk/card/ContentNormalCard;

    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/huawei/appmarket/service/store/awk/node/ContentNormalNode;->context:Landroid/content/Context;

    invoke-direct {v8, v1}, Lcom/huawei/appmarket/service/store/awk/card/ContentNormalCard;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v8, v1}, Lcom/huawei/appmarket/service/store/awk/card/ContentNormalCard;->bindCard(Landroid/view/View;)Lcom/huawei/appmarket/service/store/awk/card/BaseCard;

    new-instance v2, Lcom/huawei/appmarket/service/store/awk/card/TitleExtCard;

    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/huawei/appmarket/service/store/awk/node/ContentNormalNode;->context:Landroid/content/Context;
    ...
    invoke-virtual {v8, v2}, Lcom/huawei/appmarket/service/store/awk/card/ContentNormalCard;->setTitleCard(Lcom/huawei/appmarket/service/store/awk/card/TitleExtCard;)V
    ...
    iget-object v2, v0, Lcom/huawei/appmarket/service/store/awk/node/ContentNormalNode;->context:Landroid/content/Context;
    ...
    sget v2, Lcom/huawei/appmarket/a/a$h;->content_item_normal:I
    ...
    new-instance v14, Lcom/huawei/appmarket/service/store/awk/card/ContentNormalItemCard;

    move-object/from16 v0, p0

    iget-object v15, v0, Lcom/huawei/appmarket/service/store/awk/node/ContentNormalNode;->context:Landroid/content/Context;

    invoke-direct {v14, v15}, Lcom/huawei/appmarket/service/store/awk/card/ContentNormalItemCard;-><init>(Landroid/content/Context;)V

    invoke-virtual {v14, v2}, Lcom/huawei/appmarket/service/store/awk/card/ContentNormalItemCard;->bindCard(Landroid/view/View;)Lcom/huawei/appmarket/service/store/awk/card/BaseCard;

    invoke-virtual {v8, v14}, Lcom/huawei/appmarket/service/store/awk/card/ContentNormalCard;->addCard(Lcom/huawei/appmarket/service/store/awk/card/BaseCard;)V
    ...
    invoke-virtual {v0, v8}, Lcom/huawei/appmarket/service/store/awk/node/ContentNormalNode;->addCard(Lcom/huawei/appmarket/sdk/service/cardkit/a/a;)V
...
.method public setOnClickListener(Lcom/huawei/appmarket/sdk/service/cardkit/bean/b;)V
    ...
    :goto_0
    invoke-virtual {p0}, Lcom/huawei/appmarket/service/store/awk/node/ContentNormalNode;->getCardSize()I

    move-result v0

    if-ge v1, v0, :cond_3

    invoke-virtual {p0, v1}, Lcom/huawei/appmarket/service/store/awk/node/ContentNormalNode;->getItem(I)Lcom/huawei/appmarket/service/store/awk/card/BaseCard;

    move-result-object v0

    check-cast v0, Lcom/huawei/appmarket/service/store/awk/card/ContentNormalCard;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Lcom/huawei/appmarket/service/store/awk/card/ContentNormalCard;->getTitleCard()Lcom/huawei/appmarket/service/store/awk/card/TitleExtCard;
    ...
    :goto_1
    invoke-virtual {v0}, Lcom/huawei/appmarket/service/store/awk/card/ContentNormalCard;->getSize()I

    move-result v4

    if-ge v3, v4, :cond_2

    invoke-virtual {v0, v3}, Lcom/huawei/appmarket/service/store/awk/card/ContentNormalCard;->getItem(I)Lcom/huawei/appmarket/service/store/awk/card/BaseCard;
