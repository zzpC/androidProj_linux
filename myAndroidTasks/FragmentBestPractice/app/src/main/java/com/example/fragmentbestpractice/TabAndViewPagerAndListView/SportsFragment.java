...
public class SportsFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.news_title_sports, container, false);
    ...
    protected void initNews() {
        ...
        HttpUtil.sendHttpRequest(string, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                newsList3 = ParseDatas.parseJSON(response);
                listviewAdapter = new NewsAdapter(getActivity(), R.layout.news_item4, newsList3);
