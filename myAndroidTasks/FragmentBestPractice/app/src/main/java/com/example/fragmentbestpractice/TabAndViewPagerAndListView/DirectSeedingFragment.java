...
public class DirectSeedingFragment extends BaseFragment {
    ...
    //网络抓取来的数据
    private  List<News> newsList8 = new ArrayList<>();
    //适配
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.news_title_directseeding, container, false);
    ...
    protected void initNews() {
        ...
        HttpUtil.sendHttpRequest(string, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                newsList8 = ParseDatas.parseJSON(response);
                listviewAdapter = new NewsAdapter(getActivity(), R.layout.news_item9, newsList8);
