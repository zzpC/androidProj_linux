package com.zzpc.wynews.newsmessage.newscomment.view;
...
import com.zzpc.wynews.newsmessage.newscomment.model.Floor;
import com.zzpc.wynews.newsmessage.newscomment.util.DpPxUtil_;
...
public class FloorListView extends LinearLayout implements View.OnClickListener {
        ...
        if (null != mRectDrawable && count > 0) {
            for (int j = count - 1; j >= 0; j--) {
                ...
                if (count > 5 && j < count - 5) {
                    mLineDrawable.setBounds(view.getLeft(), view.getBottom() - DpPxUtil_.dp2px(getContext(), 2),
    ...
    public View createFloorViewForNormal(Floor floor, Context context) {
        ...
        View view = inflater.inflate(R.layout.item_comment_post_sub_comments_normal, null);
    ...
    public View createFloorViewForHide(Floor floor, Context context) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.item_comment_post_sub_comments_hide, null);
