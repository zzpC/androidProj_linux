...
import com.zzpc.wynews.newsmessage.newscomment.model.Comments;
import com.zzpc.wynews.newsmessage.newscomment.model.Topic;
import com.zzpc.wynews.newsmessage.newscomment.view.FloorListView;
            ...
            commentsView.setOnShowHideButtonClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    commentsView.postDelayed(new Runnable() {
                        public void run() {
                            commentsView.appendFloorList(Comments.parseJsonForFloorList(NewsCommentFragment.TEST_JSON_2));
                        }
                    }, 800);
                }
            });
