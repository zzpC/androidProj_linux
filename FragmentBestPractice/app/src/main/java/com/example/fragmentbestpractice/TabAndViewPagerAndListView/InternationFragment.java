...
public class InternationFragment extends BaseFragment {
    ...
    //Listview改造
    private LoadMoreListView newsTitleListView3;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        newsTitleListView3 = (LoadMoreListView) view.findViewById(R.id.news_title_list_view);
        ...
        newsTitleListView3.setOnLoadMoreListener(new LoadMoreListView.OnLoadMoreListener() {
            @Override
    ...
    protected void initNews() {
        ...
        this.sendHttpRequest(string, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                ...
                listviewAdapter = new NewsAdapter(getActivity(), R.layout.news_item3, newsList2);
