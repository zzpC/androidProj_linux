...
public class VideoFragment extends BaseFragment {
    ...
    //网络抓取来的数据
    private  List<News> newsList7 = new ArrayList<>();
    //适配
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.news_title_video, container, false);
    ...
    protected void initNews() {
        ...
        HttpUtil.sendHttpRequest(string, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                newsList7 = ParseDatas.parseJSON(response);
                listviewAdapter = new NewsAdapter(getActivity(), R.layout.news_item8, newsList7);
