...
public class PagerFragmentFactory {
    ...
    private static SparseArray<BaseFragment> mBaseFragment = new SparseArray<>();
        ...
        if (baseFragment == null) {
            ...
            switch (pos) {
                ...
                case 3:
                    ...
                    bundle.putString("url", "http://api.tianapi.com/tiyu/?key=99045f5139f5f6be0de4946eb6bcc78b&num=3&rand=1");
                    break;
                case 4:
